				...
				<div id="visual-voice" class="visual__top">
					...
					<!-- <div class="visual-innner">
						<div class="download_assets">
							<img src="../../mocks/BS0007/download_assets_font.png" alt class="download_assets__thumb"></img>
				...
				<div class="brand__content-inner">
					<div class="brand__header">
						...
						<p class="brand__header-description">
							Our voice guideline does come from our design philosophy, Emotionally Intelligent Design.<br>
							We always write with a smile, insight and design.
						</p>
					</div>
					<div class="percent-view ms">
						<img class="percent-view__img" src="../../img/elements/voice/our-voice-d.svg" alt="">
					</div>
					...
					<div class="tab-container" data-tab="textElement">
						<div id="emotionally" class="tab-container__content tab-container__content--active">
							<div class="text-element text-element--headline percent-view">
								<img class="percent-view__img" src="../../img/elements/voice/principles-d-01.png" alt="">
							</div>
						</div>
						<div id="intelligent" class="tab-container__content">
							<div class="text-element text-element--body percent-view">
								<img class="percent-view__img" src="../../img/elements/voice/principles-d-02.png" alt="">
							</div>
						</div>
						<div id="design" class="tab-container__content">
							<div class="text-element text-element--body percent-view">
								<img class="percent-view__img" src="../../img/elements/voice/principles-d-03.png" alt="">
							</div>
						</div>
					</div>
					<div class="brand__header">
					...
					<div class="tab-container" data-tab="textElement2">
						<div id="emotionally2" class="tab-container__content tab-container__content--active">
							<div class="text-element text-element--headline percent-view">
								<img class="percent-view__img" src="../../img/elements/voice/voice-flexes-01-d.png" alt="">
							</div>
						</div>
						<div id="intelligent2" class="tab-container__content">
							<div class="text-element text-element--body percent-view">
								<img class="percent-view__img" src="../../img/elements/voice/voice-flexes-02-d.png" alt="">
							</div>
						</div>
						<div id="design2" class="tab-container__content">
							<div class="text-element text-element--body percent-view">
								<img class="percent-view__img" src="../../img/elements/voice/voice-flexes-03-d.png" alt="">
							</div>
						</div>
					</div>
					<div class="brand__header">
					...
					<div class="percent-view">
						<img class="percent-view__img" src="../../img/elements/voice/message-example-smile.png" alt="">
					</div>
				</div>
