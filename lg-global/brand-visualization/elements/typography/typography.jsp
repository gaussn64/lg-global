			...
			<div id="contents">
				...
				<div class="brand__content-inner">
					...
					<div class="brand__header">
						...
						<p class="brand__header-description">
							Our slogan makes our brand feel warm and present, even in the smallest of <br>
							moments. To ensure its distinctiveness, we always use it in memorable ways to <br>
							lead or sign off.
						</p>
					</div>
