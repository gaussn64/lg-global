				...
				<div class="brand__content-inner">
					<div class="brand__header">
						...
						<p class="brand__header-description">
							At our core, LG has always been a red brand. That is still true today. <br>
							However, we’ve built outwards from our core to give our identity flex. <br>
							Incorporating ‘Active Red’ and neutral colors so we can <br>
							create excitement and restore balance when we need too.
						</p>
					</div>
					...
					<div class="brand__header">
						...
						<p class="brand__header-description">
							We can dial up and down our core palette to help express ourselves differently <br>
							across touchpoints – from feeling calm, to bold and immersive. <br>
					...
					<div class="brand__header">
						...
						<p class="brand__header-description">
							When static, we have four gradient assets going from light to dark. <br>
							Each has a unique look and feel, which can be selected<br>
